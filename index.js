...
GUIDE_BTN.addEventListener("click", function(){
    ...
    CONTEXT.fillText("CONCEPT DU JEU", (CANVAS.width/2)-10, 50);
    drawImg();
})
...
function drawImg(){
  ...
  img.src = 'images/fleche.png'; // définit le chemin de la source
  img2.src = 'images/zqsd.png'; // définit le chemin de la source
}
